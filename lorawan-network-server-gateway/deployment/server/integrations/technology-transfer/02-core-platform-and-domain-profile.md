...
payload_contract:
  version: 2
  validity_field: sensor_validity_bitmap
metrics:
  environment_temperature_c:
    source_field: environment_temperature_c
    unit: Cel
    validity_bit: 5
  environment_humidity_percent:
    source_field: environment_humidity_percent
    unit: '%'
    validity_bit: 5
  barometer_pressure_pa:
    source_field: barometer_pressure_pa
    unit: Pa
    validity_bit: 2
  rain_wet:
    source_field: rain_wet
    unit: boolean
    validity_bit: 6
  battery_v:
    source_field: battery_v
    unit: V
    sentinel_zero_means: usb_powered_or_no_meaningful_battery_value
alert_rules:
  temperature_high:
    condition: environment_temperature_c > <APPROVED_THRESHOLD_C>
...
decoder: agriculture-kit-payload-v2
