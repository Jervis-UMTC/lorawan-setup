...
The agriculture AS923-3 assumption from the current project must be revalidated for the new site. A port transfer must not inherit it blindly.
...
The system should show stale or unknown data explicitly. A missing value must not be displayed as a safe value.
...
- [IMO strategy and maritime digitalization](https://www.imo.org/en/mediacentre/pressbriefings/pages/facilitation-committee-approves-digitalization-strategy-and-cyber-security-measures.aspx)
