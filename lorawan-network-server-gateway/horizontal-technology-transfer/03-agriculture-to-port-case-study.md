...
This example shows how the same platform can support port services while the operational model changes.
...
The platform can transport a measurement. It does not by itself define whether an operator may stop a crane, release cargo, or declare a safety incident.
...
| Agricultural retention | Commercial, safety, environmental, or regulatory retention | Obtain data-owner approval |
...
Use the pilot to validate operational value, not only MQTT packet delivery.
