...
Keep one canonical normalized record in the telemetry system, then create adapters for target systems. Do not create a different decoder and business interpretation for every consumer.
