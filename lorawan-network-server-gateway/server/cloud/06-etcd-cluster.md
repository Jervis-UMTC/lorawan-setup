...
Each of `db-01`, `db-02`, and `db-03` runs one etcd member and one Spilo/Patroni member.
...
Create `/etc/etcd/etcd.yml` independently on each node. This example is for `dcs-01`; replace every placeholder.
