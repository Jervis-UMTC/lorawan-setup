...
The current example profile uses Dragino S31/S31B temperature, humidity, and battery fields. That codec and metric mapping are not a generic domain contract.
